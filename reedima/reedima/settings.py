"""
Django settings for reedima project.
...
SECRET_KEY = 'i)s(y@7vj#e&^ap90w^e6$_1(ssxcec+oi@6xwzx7x*c-snzdy'
...
WSGI_APPLICATION = 'reedima.wsgi.application'
